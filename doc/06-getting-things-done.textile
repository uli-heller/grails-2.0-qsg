...
Running all the tests with @../../bin/grails.sh test-app@ produces lots of errors:

* the scaffolded default tests of the domain classes fail for Grails-2.x.y.
** test/unit/tekdays/MessageTests.groovy
** test/unit/tekdays/SponsorTests.groovy
** test/unit/tekdays/SponsorshipTests.groovy
** test/unit/tekdays/TaskTests.groovy


TBD:

* Layout: Broken
* Tests for Controllers do fail
