...
bc. 
uli@uli-desktop:~/git/grails-qsg/chapter-06/TekDays$ ../../bin/grails.sh create-service Task
...
bc. 
uli@uli-desktop:~/git/grails-qsg/chapter-06/TekDays$ mkdir test/integration/tekdays
uli@uli-desktop:~/git/grails-qsg/chapter-06/TekDays$ mv test/unit/tekdays/TaskServiceTests.groovy test/integration/tekdays/.
