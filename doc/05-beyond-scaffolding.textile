...
This document referres to chapter 5 of the "Grails Quick Start Guide". You have to initialize the project with these commands:

bc. 
uli@uli-desktop:~/git/grails-qsg/chapter-05/TekDays$ echo "y"|../../bin/grails.sh upgrade
...
bc. 
li@uli-desktop:~/git/grails-qsg/chapter-05/TekDays$ ../../bin/grails.sh generate-all "*"
