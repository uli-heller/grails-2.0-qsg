...
Dieses Dokument beschreibt das Kapitel 3 vom "Grails Quick Start Guide". Zunächst muß mit

bc. 
uli@uli-desktop:~/git/grails-qsg/chapter-03/TekDays$ echo "y"|../../bin/grails.sh upgrade
...
bc. 
uli@uli-desktop:~/git/grails-qsg/chapter-03/TekDays$ ../../bin/grails.sh create-domain-class TekEvent
