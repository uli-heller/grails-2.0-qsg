...
bc. 
uli@uli-desktop:~/git/grails-qsg/chapter-04/TekDays$ ../../bin/grails.sh create-domain-class Task
| Created file grails-app/domain/tekdays/Task.groovy
| Created file test/unit/tekdays/TaskTests.groovy

bc. 
uli@uli-desktop:~/git/grails-qsg/chapter-04/TekDays$ ../../bin/grails.sh create-domain-class Message
